...
class LevelHashing: public IHash {
  private:
    Node *buckets[2];
...
//    uint32_t occupied;
  ...
  public:
	...
	void Insert_extent(Key_t, uint64_t, uint64_t, Value_t) {return ;}
	Value_t Get_extent(Key_t&, uint64_t) { return NONE;}
	Value_t FindAnyway(Key_t&) {return NONE;}
