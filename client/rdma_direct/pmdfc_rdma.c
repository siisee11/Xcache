...
#include "pmdfc_rdma.h"
#include <linux/slab.h>
#include <linux/cpumask.h>

static struct pmdfc_rdma_ctrl *gctrl;
...
static void __exit pmdfc_rdma_cleanup_module(void)
{
...
inline static int pmdfc_rdma_post_rdma(struct rdma_queue *q, struct rdma_req *qe,
...
EXPORT_SYMBOL(pmdfc_rdma_write);
...
EXPORT_SYMBOL(pmdfc_rdma_read_async);
...
EXPORT_SYMBOL(pmdfc_rdma_read_sync);
...
static int __init pmdfc_rdma_init_module(void)
{
  int ret;
...
module_init(pmdfc_rdma_init_module);
module_exit(pmdfc_rdma_cleanup_module);

MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("pmdfc rdma direct");
